  ...
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="divide-y divide-paper/15">
      @foreach ([
        ...
        ['accent' => 'bg-violet', 'name' => 'PAZ', 'desc' => 'Peace Advocates Zamboanga — a non-profit engaged in the promotion of peace, interreligious dialogue, and advocacy.', 'img' => 'paz_logo.jpg'],
        ...
        ['accent' => 'bg-clay', 'name' => 'NFI', 'desc' => 'Nagdilaab Foundation Inc. — capability building, conflict transformation, dialogue, cultural contextualization, peacebuilding, and human rights in Basilan.', 'img' => 'nagdilaab_logo.png'],
        ['accent' => 'bg-palm', 'name' => 'Campo Vida', 'desc' => 'Campo Vida Agricultural Learning Center Inc. — promotes sustainable agriculture, farmer education, livelihood and enterprise development, environmental stewardship, and inclusive community empowerment.', 'img' => 'campovida.png'],
      ] as $org)
