...
{{-- Design guideline note: kept on the Tailwind CDN + Google Fonts approach
     already established by the original site, so the visual system (and
     Bluehost deployment) stays simple — no Node build step required on
     the server. Swap for a compiled build later if desired. --}}
...
{{-- Global flash banner: success/error feedback for contact, login,
     admin actions, sync — visible, not just a silent redirect. --}}
