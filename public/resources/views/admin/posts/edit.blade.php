...
<form method="POST" action="{{ route('admin.posts.update', $post) }}" enctype="multipart/form-data" class="max-w-2xl" id="post-form">
  @include('admin.posts._form')

  <button type="submit" id="post-submit" class="bg-ink text-paper px-6 py-3 text-sm uppercase tracking-wide hover:bg-clay transition-colors disabled:opacity-60 inline-flex items-center gap-2">
    <span data-default-label>Save changes</span>
