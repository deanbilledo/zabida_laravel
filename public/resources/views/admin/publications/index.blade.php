  ...
  @forelse ($publications as $publication)
    <div class="flex items-center justify-between gap-4 py-4">
      ...
      <div class="flex items-center gap-4 flex-shrink-0">
        ...
        <form method="POST" action="{{ route('admin.publications.destroy', $publication) }}" onsubmit="return confirm('Remove &quot;{{ $publication->title }}&quot; from the archive? This can\'t be undone.');">
          @csrf
          @method('DELETE')
